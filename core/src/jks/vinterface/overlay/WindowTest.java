 ...
 * @author Nathan Sweet */
public class WindowTest extends Table {
	...
	public WindowTest (String title, Skin skin) {
		this(title, skin.get(WindowStyle.class));
		setSkin(skin);
	}

	public WindowTest (String title, Skin skin, String styleName) {
		this(title, skin.get(styleName, WindowStyle.class));
		setSkin(skin);
	}

	public WindowTest (String title, WindowStyle style) {
...
//		addActor(titleTable);
	...
	public void setStyle (WindowStyle style) {
		...
		this.style = style;
		setBackground(style.background); // TODO TODO SIMON HERE
